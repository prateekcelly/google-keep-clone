...
import styles from './PalatteIcon.module.css';
...
const PaletteIcon = (props) => {
  ...
  return (
    <div className={styles['palette-icon']}>
      <div
        className={
      ...
      >
        <path
          d="M22.082,2.61c-3.74,0-7.598,0.592-11.465,1.76C9.503,4.706,6.115,5.73,4.877,9.082c-1.222,3.312,0.536,6.051,1.819,8.052
